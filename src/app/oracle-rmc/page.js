...
const RMC_CARDS = [
  { icon: '🔍', title: 'Anomaly Detection', desc: 'Continuous scanning with intelligent baselines that flag unusual access patterns and transactional anomalies before they become incidents.' },
  { icon: '🤖', title: 'Machine Learning Engine', desc: 'Self-learning risk models that adapt to your enterprise\'s behaviour patterns, continuously improving detection with every data point.' },
  { icon: '📋', title: 'Compliance Frameworks', desc: 'Out-of-the-box templates for GDPR, SOX, ISO 27001, and 20+ regional regulatory frameworks across 18 countries.' },
  { icon: '🔗', title: 'Enterprise Connectors', desc: 'Native integrations with Oracle Cloud, SAP, and 50+ enterprise systems. REST APIs for any custom environment.' },
  { icon: '📊', title: 'Risk Analytics', desc: 'Deep-dive analytics with configurable risk scoring, trend analysis, and predictive insights for proactive risk management.' },
  { icon: '🛡️', title: 'Enterprise Security', desc: 'SOC 2 Type II certified. Role-based access control, end-to-end encryption, full audit trails, and multi-tenancy support.' },
];
          ...
          <div className="irm-cards">
            {RMC_CARDS.map(card => (
              <div className="icard rv" key={card.title}>
                <div className="icard-icon">{card.icon}</div>
